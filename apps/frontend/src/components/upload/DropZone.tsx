...
export function DropZone({ onFile, disabled }: DropZoneProps) {
  ...
  const borderColor = isDragReject
    ...
    : "border-warm-border bg-white hover:border-brand-500 hover:bg-warm-surface2";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        <svg className="w-12 h-12 text-warm-faint" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {isDragReject ? (
          ...
          <>
            ...
            <p className="text-warm-faint text-sm">JPEG, PNG o WebP · Máx. 10MB</p>
          </>
        )}
      </div>
    </div>
